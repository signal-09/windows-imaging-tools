...
mount -t overlay -o lowerdir=$TMP_MOUNT_PATH/iso,upperdir=$TMP_MOUNT_PATH/upper,workdir=$TMP_MOUNT_PATH/workdir none $TMP_MOUNT_PATH/overlay
mv $TMP_MOUNT_PATH/overlay/efi/microsoft/boot/efisys.bin $TMP_MOUNT_PATH/overlay/efi/microsoft/boot/efisys_prompt.bin
mv $TMP_MOUNT_PATH/overlay/efi/microsoft/boot/cdboot.efi $TMP_MOUNT_PATH/overlay/efi/microsoft/boot/cdboot_prompt.efi
cp $TMP_MOUNT_PATH/overlay/efi/microsoft/boot/efisys_noprompt.bin $TMP_MOUNT_PATH/overlay/efi/microsoft/boot/efisys.bin
cp $TMP_MOUNT_PATH/overlay/efi/microsoft/boot/cdboot_noprompt.efi $TMP_MOUNT_PATH/overlay/efi/microsoft/boot/cdboot.efi
